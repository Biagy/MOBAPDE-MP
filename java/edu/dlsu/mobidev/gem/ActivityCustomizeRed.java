...
public class ActivityCustomizeRed extends AppCompatActivity {
    ...
    public ArrayList<RectPlayer> redBotList;
...
//        SpinnerAdapter fidget;
        ...
        index = 0;
        redBotList = new ArrayList<RectPlayer>();
        initData();
        setButtonClicks();
        selectedBot = redBotList.get(0);
        updateSelected();
    }
    ...
    public void setButtonClicks(){
        ...
        startGame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(),MultiPlayerGame.class);
                startActivity(i);
                finish();
            }
        });
        ...
        headRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imgBot.setImageResource(redBotList.get(index).getBotSprite());
                selectedBot = redBotList.get(index);
                updateSelected();
            }
        });
...
//        redBotList.add(bob);
        ...
        //ammo s 2
//               a + 3
        redBotList.add(new RectPlayer(true,5,1,15,8,R.drawable.h1a1s1r));
        redBotList.add(new RectPlayer(true,5,1,20,5,R.drawable.h1a1s2r));
        redBotList.add(new RectPlayer(true,8,1,15,5,R.drawable.h1a1s3r));
        redBotList.add(new RectPlayer(true,5,1,18,6,R.drawable.h1a2s1r));
        redBotList.add(new RectPlayer(true,5,1,23,3,R.drawable.h1a2s2r));
        redBotList.add(new RectPlayer(true,8,1,18,3,R.drawable.h1a2s3r));
        redBotList.add(new RectPlayer(true,10,1,15,6,R.drawable.h1a3s1r));
        redBotList.add(new RectPlayer(true,10,1,20,3,R.drawable.h1a3s2r));
        redBotList.add(new RectPlayer(true,13,1,15,3,R.drawable.h1a3s3r));

        redBotList.add(new RectPlayer(true,5,2,15,8,R.drawable.h2a1s1r));
        redBotList.add(new RectPlayer(true,5,2,20,5,R.drawable.h2a1s2r));
        redBotList.add(new RectPlayer(true,8,2,15,5,R.drawable.h2a1s3r));
        redBotList.add(new RectPlayer(true,5,2,18,6,R.drawable.h2a2s1r));
        redBotList.add(new RectPlayer(true,5,2,23,3,R.drawable.h2a2s2r));
        redBotList.add(new RectPlayer(true,8,2,18,3,R.drawable.h2a2s3r));
        redBotList.add(new RectPlayer(true,10,2,15,6,R.drawable.h2a3s1r));
        redBotList.add(new RectPlayer(true,10,2,20,3,R.drawable.h2a3s2r));
        redBotList.add(new RectPlayer(true,13,2,15,3,R.drawable.h2a3s3r));
